...
class UserInfo(models.Model):
    ...
    userDetail = models.OneToOneField(to=User,null=True)
...
class ClassList(models.Model):
    ...
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={"depart":1003})
...
class CustomerDistrbute(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to="UserInfo", limit_choices_to={"depart_id": 1003})
